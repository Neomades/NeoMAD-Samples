...
import com.neomades.asynclist.adapterwithholder.ItemListAdapter;
 ...
 */
public final class AsyncListScreen extends Screen implements ClickListener, ItemClickedListener {
	...
	protected void onCreate() {
		...
		listAdapter = new ItemListAdapter(items);
